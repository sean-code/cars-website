        ...
        <Row>
          <Col lg="6" md="6">
            <div className="about__section-content">
              <h2 className="section__subtitle" style={{"fontWeight":"800", fontSize:"larger"}}>About Us</h2>
              <p className="section__description">
              Welcome to our car rental services! 
              <br/>Here you'll find a wide selection of vehicles to suit all
          ...
          <Col lg="6" md="6">
            <div className="about__img">
              <img src={aboutImg} alt="red-car" className="w-100" />
            </div>
          </Col>
        </Row>
      </Container>
