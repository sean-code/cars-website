    ...
    return(
        <>
            <div className='mn-container'>
                ...
                <Link to={`/our-cars/${singleCarItem.make}/payment/mpesa`}>
                    <a className='btn-links' href={`/our-cars/${singleCarItem.make}/payment/mpesa`}>
                    ...
                    <Link to={`/our-cars/${singleCarItem.make}/payment/card`}>
                        <a className= 'btn-links' href={`/our-cars/${singleCarItem.make}/payment/card`}>
